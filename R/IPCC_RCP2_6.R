...
#'             according to the IPCC RCP2.6 scenario (2014) on the abundance of ectotherm populations.
#'
#'
...
#'
#'@details Three populations can be simulated simultaneously. The temperature trend is determined by
#'         a projection of the change in global mean surface temperature according to the IPCC RCP2.6
#'         scenario. In each input vector, the parameters for the three simulations must be specified
#'         (finite numbers for initial population abundance). The simulations are obtained by a model
#'         that incorporates the effects of temperature over time, which leads to a non-autonomous ODE
#'         approach. This is function uses the ODE solver implemented in the package deSolve
#'         (Soetaert et al., 2010).
#'
#'
#'
...
#'#######################################################################
#'
#'IPCC_RCP2_6(y_ini = c(N = 100, N = 200, N = 400),
#'            temp_ini = rep(26,3),
#'            temp_cmin = rep(18,3),
#'            temp_cmax = rep(40,3),
#'            ro = rep(0.7,3),
...
#'
#'IPCC_RCP2_6(y_ini = c(N = 100, N = 100, N = 100),
#'            temp_ini = rep(26,3),
