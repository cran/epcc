#'  Periodic decreasing temperature trend
#'
#' @description This function simulates the effect of a decrease temperature trend
...
#'@param B Parameter specifying the period of the trend (period is (2 pi)/|B|).
#'@param m Decreasing slope.
...
decreasing_periodicity<- function(y_ini = c(N = 400, N = 400, N = 400),
                                  temp_ini = rep(20,3),
                                  temp_cmin = rep(18,3),
